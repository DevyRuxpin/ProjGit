...
async function makeCardRequest(url) {
...
async function getSingleCard() {
    ...
    try {
        ...
        const data = await makeCardRequest(url);
...
async function getTwoCards() {
    ...
    try {
        ...
        const firstData = await makeCardRequest(firstCardUrl);
        ...
        const secondData = await makeCardRequest(secondCardUrl);
